...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__c",
      "vtp_value":"GTM-0000-0000"
    },{
      "function":"__c",
      "vtp_value":"AW-00000-0000"
    },{
      "function":"__f",
      "vtp_component":"URL"
    },{
  ...
  "tags":[{
      ...
      "vtp_uniqueTriggerId":"33961325_4",
      "tag_id":38
    },{
      "function":"__evl",
      ...
      "vtp_uniqueTriggerId":"33961325_8",
      "tag_id":39
    },{
      "function":"__sdl",
      ...
      "vtp_uniqueTriggerId":"33961325_13",
      ...
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"33961325_18",
      "tag_id":41
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"33961325_20",
      "tag_id":42
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"33961325_27",
      "tag_id":43
    },{
      "function":"__html",
      "metadata":["map"],
      ...
      "consent":["list"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Efunction setCookie(c,d,a,e){var b=new Date;b.setTime(b.getTime()+864E5*a);a=\"expires\\x3d\"+b.toUTCString();document.cookie=c+\"\\x3d\"+d+\";\"+a+\";path\\x3d\/ ; domain\\x3d\"+e}setCookie(\"InternalTraffic\",\"true\",365,\"wordcube.com\/jobs\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":37
  ...
  "rules":[
    [["if",0,1,2],["add",0]],
    [["if",3,4],["add",1,9]],
    [["if",5],["add",2,6,7,8,10,11,12,19,13,14,17,18]],
    [["if",6],["add",3,9]],
    [["if",7,8],["add",4]],
    [["if",9,10],["add",5,9]],
    [["if",11],["add",15]],
...
var Nd=[B.B,B.I],Od=function(a){var b=a[B.Sd];b&&E(40);var c=a[B.Td];c&&E(41);for(var d=Ea(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==B.Sd&&f!==B.Td)if(-1<Fa(Nd,f)){var h=f,k=a[f],l=d[e];yd().set(h,k,l,"CN","CN-12",c)}else{}},Pd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
d,0))/h,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0};var ae=[],be=!(!G.IntersectionObserver||!G.IntersectionObserverEntry),ce=function(a,b,c){for(var d=new G.IntersectionObserver(a,{threshold:c}),e=0;e<b.length;e++)d.observe(b[e]);for(var f=0;f<ae.length;f++)if(!ae[f])return ae[f]=d,f;return ae.push(d)-1},de=function(a,b,c){function d(k,l){var n={top:0,bottom:0,right:0,left:0,width:0,height:0},q={boundingClientRect:k.getBoundingClientRect(),
intersectionRatio:l,intersectionRect:n,isIntersecting:0<l,rootBounds:n,target:k,time:Wa()};J(function(){return a(q)})}for(var e=[],f=[],h=0;h<b.length;h++)e.push(0),f.push(-1);c.sort(function(k,l){return k-l});return function(){for(var k=0;k<b.length;k++){var l=$d(b[k]);if(l>e[k])for(;f[k]<c.length-1&&l>=c[f[k]+1];)d(b[k],l),f[k]++;else if(l<e[k])for(;0<=f[k]&&l<=c[f[k]];)d(b[k],l),f[k]--;e[k]=l}}},ee=function(a,b,c){for(var d=0;d<c.length;d++)1<c[d]?c[d]=1:0>c[d]&&(c[d]=0);if(be){var e=!1;J(function(){e||
de(a,b,c)()});return ce(function(f){e=!0;for(var h={lb:0};h.lb<f.length;h={lb:h.lb},h.lb++)J(function(k){return function(){return a(f[k.lb])}}(h))},b,c)}return G.setInterval(de(a,b,c),1E3)},fe=function(a){be?0<=a&&a<ae.length&&ae[a]&&(ae[a].disconnect(),ae[a]=void 0):G.clearInterval(a)};var ge=/:[0-9]+$/,ke=function(a,b,c){for(var d=a.split("&"),e=0;e<d.length;e++){var f=d[e].split("=");if(decodeURIComponent(f[0]).replace(/\+/g," ")===b){var h=f.slice(1).join("=");return c?h:decodeURIComponent(h).replace(/\+/g," ")}}},ne=function(a,b,c,d,e){b&&(b=String(b).toLowerCase());if("protocol"===b||"port"===b)a.protocol=le(a.protocol)||le(G.location.protocol);"port"===b?a.port=String(Number(a.hostname?a.port:G.location.port)||("http"==a.protocol?80:"https"==a.protocol?443:"")):"host"===b&&
...
Z.g.evl=["google"],function(){function a(){var f=Number(vn("gtm.start"))||0;return rn().getTime()-f}function b(f,h,k,l){function n(){if(!Yd(f.target)){h.has(d.kc)||h.set(d.kc,""+a());h.has(d.fd)||h.set(d.fd,""+a());var p=0;h.has(d.oc)&&(p=Number(h.get(d.oc)));p+=100;h.set(d.oc,""+p);if(p>=k){var r=Sl(f.target,"gtm.elementVisibility",[h.m]),u=$d(f.target);r["gtm.visibleRatio"]=Math.round(1E3*u)/10;r["gtm.visibleTime"]=k;r["gtm.visibleFirstTime"]=Number(h.get(d.fd));r["gtm.visibleLastTime"]=Number(h.get(d.kc));
