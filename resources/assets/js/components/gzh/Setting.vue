	...
	<div>
		...
		<el-card shadow="hover" class="margin_top">
			...
			<el-row :gutter="20">
				...
				<el-col :span="12" v-show="this.article.qrcode">
					<img  :src="this.article.qrcode" class="login_cover">
				</el-col>
			</el-row>
			<el-row :gutter="20">
				<el-col :span="10">
					<el-form>
						<el-form-item>
							<el-button type="primary" @click="submitForm()" :loading="loading" size="small" style="float: right">保存设置</el-button>
						</el-form-item>
					</el-form>
				</el-col>
			</el-row>
	...
	export default {
		...
		methods: {
			successUpload(response, file, fileList) {
				this.loading = false
				this.article.qrcode = response.data.path
			},
			submitForm() {
				this.loading = true
