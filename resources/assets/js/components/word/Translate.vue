...
<div v-loading="loading">
    <el-row>
        ...
        <el-card shadow="hover">
            ...
            <p class="translate_desc">Pages:
                <span v-for="(url,name) in obj.pages" style="margin-right: 10px"><a :href="url | ContainsHttp">{{name}}</a> | </span>
            </p>
            <el-form ref="form" :model="translate" :rules="rules" size="medium" label-position="top">
                <el-form-item label="Word :">
                    <el-input v-model="obj.word" disabled type="textarea" :autosize="autosize"></el-input>
                </el-form-item>
                ...
                <el-form-item prop="word">
                    ...
                    <el-input v-model="translate.word" type="textarea"
...
<script type="text/javascript">
    ...
    export default {
        data: function() {
            return {
                rules: {
                    word: [{required: true, message: 'Required', trigger: 'blur'}],
                },
                translate:{
        ...
        methods: {
            ...
            translateRecord(){
                ...
                axios.post( '/admin/translate/record',
                    {model:'DbTermsTranslation',relate_id:'word_id', id:this.translate.word_id, locale:this.translate.locale})
                    .then(res => {
                        if (res.data.code != 0 || res.status != 200) {
                            ...
                            if (res.data.data){
                                ...
                                this.translate.word = res.data.data.word
                            }else{
